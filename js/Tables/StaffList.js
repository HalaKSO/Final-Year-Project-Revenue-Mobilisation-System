...

            {
                ...
                "render": function (data) {
                    return `<div class='text-center'>
                        ...
                        <a class='btn btn-success'   href='/OfficerAdmin/StaffDetails?id=${data}' title='Detail'><span class='fas fa-detail'></span></a>
                        <a class='btn btn-danger text-white' onClick=Delete('/OfficerAdmin/RemoveStaff?id=${data}') title='Delete' style='cursor:pointer' ><span class='fas fa-trash-alt'></span></a>
